...
print(f"Greatest Increase in Profits: {avg_change_dict[date_of_max_profit]} (${(str(max_profit))})\n")
print(f"Greatest Decrease in Profits: {avg_change_dict[date_of_min_profit]} (${(str(min_profit))})\n")
